...
public class Link extends TableImpl<LinkRecord> {
    ...
    /**
     * The column <code>LINK.UPDATE_AT</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> UPDATE_AT = createField(DSL.name("update_at"), SQLDataType.OFFSETDATETIME(6), this, "");

    /**
     * The column <code>LINK.LAST_API_UPDATE</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_API_UPDATE = createField(DSL.name("last_api_update"), SQLDataType.OFFSETDATETIME(6), this, "");
